...
const SubscriptionCard = ({ name, price, currency, icon, billing, color, plan, category, renewalDate, onPress, expanded, paymentMethod, status, startDate }: SubscriptionCardProps) => {
    return (
                    ...
                    <View className='sub-details'>
                        ...
                        <View className='sub-row'>
                            <View className='sub-row-copy'>
                                ...
                                <Text className='sub-value' numberOfLines={1} ellipsizeMode='tail'>{status?.trim() ?? "Not provided"}</Text>
                            </View>
                        </View>
